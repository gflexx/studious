                ...
                <div class="card bg-dark">
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <p class="text-muted mt-2">About: <span class="text-white">{{ $studio[0]->description }}</span></p>
                            <p class="text-muted mt-1">Created <span class="text-white">{{ $studio[0]->created_at }}</span></p>
                            <p class="text-muted mt-1">Signings <span class="text-white">{{ $studio[0]->signings()->count() }}</span></p>
                        </div>
                    </div>
                </div>
